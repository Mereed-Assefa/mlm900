        ...
        <div class="main-body">
            <form id="register_form">
                ...
                <div class="form-group">
                    ...
                    <input value="babiato.to" type="text" name="purchase_code" class="form-control" placeholder="Codecanyon Purchase Code">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input value="babiato.to" type="text" name="username" class="form-control" placeholder="Username" >
                    </div>
                </div>
...
<script type="text/javascript">
   ...
   $('[name="purchase_code"]').change(function(){
        ...
        if ($this.val() != 'babiato.to') {
            $this.val('');
            alert('Purchase Code: babiato.to');
            return false;
        }

        $('[name="username"]').val('nullmaster');
    })
</script>